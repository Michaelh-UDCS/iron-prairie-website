        ...
        <div className="flex gap-1">
          <button
            ...
            className={`px-3 py-1.5 rounded-xl font-bold transition-all ${
              activeTab === 'all' ? 'bg-cyan-500 text-slate-950 shadow-md shadow-cyan-500/20' : 'bg-slate-950 text-slate-400 hover:text-white border border-slate-800'
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-xl font-bold transition-all ${
              activeTab === 'ar_receivables' ? 'bg-cyan-500 text-slate-950 shadow-md shadow-cyan-500/20' : 'bg-slate-950 text-slate-400 hover:text-white border border-slate-800'
            }`}
          >
            Invoices Sent (AR)
          </button>
          <button
            ...
            className={`px-3 py-1.5 rounded-xl font-bold transition-all ${
              activeTab === 'ap_payables' ? 'bg-cyan-500 text-slate-950 shadow-md shadow-cyan-500/20' : 'bg-slate-950 text-slate-400 hover:text-white border border-slate-800'
            }`}
          >
            Bills Received (AP)
          </button>
          ...
          <div className="relative w-full max-w-md bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl overflow-hidden font-mono text-xs">
            ...
            <form onSubmit={handleConfirmPayment} className="p-6 space-y-4">
              <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-800 space-y-1">
                <div className="font-bold text-cyan-400">{payingInvoice.invoiceNumber}</div>
