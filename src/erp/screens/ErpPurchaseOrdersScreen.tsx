          ...
          <div className="flex bg-slate-900 p-1 rounded-xl border border-slate-800">
            <button
              ...
              className={`px-3 py-1.5 rounded-lg font-bold transition-all ${
                activeTab === 'pos' ? 'bg-cyan-500 text-slate-950 shadow-md shadow-cyan-500/20' : 'text-slate-400 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg font-bold transition-all ${
                activeTab === 'suppliers' ? 'bg-cyan-500 text-slate-950 shadow-md shadow-cyan-500/20' : 'text-slate-400 hover:text-white'
              }`}
            >
            ...
            <tbody className="divide-y divide-slate-800">
              {filteredPos.map((po) => (
                <tr key={po.poNumber} className="hover:bg-slate-800/40 transition-colors">
                  <td className="p-3 font-black text-cyan-400">{po.poNumber}</td>
              ...
              <div key={supp.id} className="p-5 rounded-2xl bg-slate-900 border border-slate-800 space-y-3 shadow">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <span className="text-[10px] text-cyan-400 font-semibold">{supp.category}</span>
                  </div>
