      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 space-y-3">
          <div className="flex items-center justify-between text-xs text-slate-400 font-bold uppercase pb-1">
            ...
            <span className="text-cyan-400">ASME / ISO 9001</span>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-[10px] text-slate-500 pt-1 border-t border-slate-900">
                    ...
                    <span className="text-cyan-300 font-bold">Disp: {ncr.disposition}</span>
                  </div>
                </div>
              );
            })}
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-5">
              ...
              <div className="grid grid-cols-3 gap-3 bg-slate-950 p-4 rounded-xl border border-slate-800 text-[11px]">
                <div>
                  ...
                  <div className="font-bold text-cyan-400">{selectedNcr.linkedJobNumber || 'General Stock'}</div>
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  ...
                  <div className="p-3 bg-slate-950 rounded-xl border border-slate-800 font-bold text-cyan-400">
