  ...
  return (
    <div className="container-page flex min-h-[60vh] flex-col items-center justify-center text-center">
      ...
      <p className="mt-4 max-w-lg text-sm leading-relaxed text-brand-muted">
        The page you are looking for has moved or does not exist. Iron Prairie Fabrication Group LLC provides structural steel, custom gates, bunkers, and welding across Freeport and Texas.
      </p>
