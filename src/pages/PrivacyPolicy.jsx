    ...
    <div className="container-page space-y-8">
      ...
      <section className="rounded-2xl bg-white border border-stone-200/90 p-6 text-slate-800 shadow-sm">
        ...
        <div className="mt-4 space-y-1 text-xs text-slate-700 font-mono">
          ...
          <div>Phone: <a href="tel:(979)248-9266" data-ga-location="privacy_policy_phone" className="text-brand-brown underline hover:text-brand-brown-light">(979) 248-9266</a></div>
