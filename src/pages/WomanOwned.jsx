...
export default function WomanOwned() {
  return (
    <div className="container-page space-y-10">
      ...
      <section className="rounded-3xl border border-sky-800/40 bg-gradient-to-br from-slate-900 via-slate-850 to-slate-900 text-white p-6 sm:p-8 shadow-xl">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-slate-800">
          <div className="space-y-1">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-sky-500/20 text-sky-300 border border-sky-500/30 text-xs font-mono font-bold uppercase tracking-wider">
              <Building className="h-3.5 w-3.5 text-sky-400" /> Official Procurement Data
            </div>
        ...
        <div className="grid gap-6 mt-6 md:grid-cols-3">
          ...
          <div className="rounded-2xl bg-slate-950/80 border border-slate-800 p-5 space-y-3">
            ...
            <div className="font-mono text-lg font-black text-amber-400 bg-slate-900 px-3 py-2 rounded-xl border border-amber-500/30 tracking-widest">
              XX7XCMGN9XD5
            </div>
            <div className="text-xs text-slate-300 space-y-1 pt-1 font-mono">
              ...
              <div><strong>Physical Shop:</strong> Lake Jackson, TX 77566</div>
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-slate-950/80 border border-slate-800 p-5 space-y-2">
            ...
            <ul className="space-y-1 text-xs text-slate-300 font-mono">
              <li><strong className="text-sky-300">332312</strong> &ndash; Fabricated Structural Metal</li>
              <li><strong className="text-sky-300">332313</strong> &ndash; Plate Work Manufacturing</li>
              <li><strong className="text-sky-300">332710</strong> &ndash; Machine Shops &amp; CNC Plasma</li>
              <li><strong className="text-sky-300">332996</strong> &ndash; Fabricated Pipe &amp; Fittings</li>
              <li><strong className="text-sky-300">332323</strong> &ndash; Ornamental &amp; Architectural Metal</li>
            </ul>
          </div>
