            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  >
                    ...
                    <option value="Direct ACH / Wire Transfer (0% Fee)">Direct ACH / Wire Transfer (0% Fee)</option>
              ...
              {totalAmount >= 5000 && (
                <div className="rounded-xl border border-sky-500/30 bg-sky-950/20 p-3 text-xs text-sky-300 flex items-start gap-2">
                  ...
                  <div>
                    <strong className="text-sky-200">Commercial Account Term:</strong> Orders &ge; $5,000 are settled via <strong>Direct ACH / Electronic Wire</strong> to Business Checking on Net 30 maturity to prevent merchant processing surcharges.
                  </div>
                </div>
              )}
