        ...
        <div className="p-8 space-y-6 text-slate-100 print:text-black print:p-6 print:space-y-4 font-mono text-xs">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-slate-950/60 print:bg-slate-100 p-3.5 rounded-xl border border-slate-800 print:border-black">
            ...
            <div>
              ...
              <div className="text-[10px] text-amber-400 print:text-black font-bold">{order.priority}</div>
            </div>
            <div>
          ...
          <div>
            <div className="text-xs font-bold uppercase text-amber-400 print:text-black mb-2 flex items-center gap-1.5">
              ...
              <tbody className="divide-y divide-slate-800 print:divide-black">
                {order.items.map((item, idx) => (
                  <tr key={idx} className="hover:bg-slate-800/40 print:hover:bg-transparent">
                    ...
                    <td className="p-2 border border-slate-800 print:border-black font-bold text-amber-300 print:text-black">
                      {item.materialCode}
                    </td>
                    <td className="p-2 border border-slate-800 print:border-black">
          ...
          <div className="p-3.5 rounded-xl border-2 border-dashed border-amber-500/40 print:border-black bg-amber-500/5 print:bg-transparent">
            <div className="flex justify-between items-center mb-2">
              <div className="font-bold text-amber-400 print:text-black uppercase text-xs flex items-center gap-1.5">
