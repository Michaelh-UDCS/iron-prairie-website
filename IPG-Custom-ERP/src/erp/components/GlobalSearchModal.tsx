        ...
        <div className="max-h-[420px] overflow-y-auto p-3 divide-y divide-slate-800/60">
          {query.trim() === '' ? (
            <div className="p-8 text-center text-slate-500">
              <Search className="h-8 w-8 mx-auto mb-2 opacity-40 text-amber-400" />
              <p className="text-xs">Type a Job # (e.g. <span className="text-amber-400 font-bold">IPG-WO-2026-0101</span>), Heat # (e.g. <span className="text-amber-400 font-bold">K49201</span>), PO #, or Client name.</p>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="p-2 rounded-lg bg-slate-950 border border-slate-800 text-amber-400 group-hover:border-amber-400/40 shrink-0">
                      <Icon className="h-4 w-4" />
                    </div>
                    <div className="min-w-0">
                      <div
                        className="font-bold text-slate-100 group-hover:text-amber-400 truncate"
