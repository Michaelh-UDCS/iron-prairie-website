          ...
          {selectedDoc ? (
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-5">
              ...
              <div className="flex justify-between items-start border-b border-slate-800 pb-4">
                <div>
                  <div className="text-[10px] text-amber-400 font-bold uppercase">{selectedDoc.category}</div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 bg-slate-950 p-4 rounded-xl border border-slate-800 text-[11px]">
                <div>
                  ...
                  <div className="font-bold text-amber-400">{selectedDoc.linkedJobNumber || 'General Vault'}</div>
                </div>
                <div>
              ...
              <div className="p-6 bg-slate-950 rounded-xl border border-slate-800 text-center space-y-2">
                <FileText className="h-10 w-10 mx-auto text-amber-400/80" />
              ...
              {selectedDoc.linkedJobNumber && (
                <div className="flex justify-between items-center pt-2 border-t border-slate-800">
                  ...
                  <button
                    ...
                    className="px-3 py-1 rounded-xl bg-amber-500/20 text-amber-300 border border-amber-500/40 font-bold hover:bg-amber-500/30"
                  >
            ...
            <div className="p-12 text-center text-slate-600 bg-slate-900 border border-slate-800 rounded-2xl">
              <FolderKanban className="h-10 w-10 mx-auto mb-2 opacity-40 text-amber-400" />
