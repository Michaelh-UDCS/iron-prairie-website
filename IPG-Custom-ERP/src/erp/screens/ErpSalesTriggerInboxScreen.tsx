    ...
    <div className="space-y-6 font-mono text-xs text-slate-100">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-black shadow transition-all active:scale-95"
        >
            ...
            {salesEmailTriggers.map((trig) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-[11px] text-amber-400 font-semibold truncate">{trig.subject}</div>
                  ...
                  <div className="flex items-center justify-between text-[10px] pt-2 border-t border-slate-900">
                    ...
                    {trig.generatedJobNumber ? (
                      ...
                      <span className="text-amber-400 font-bold">Unprocessed</span>
                    )}
                  </div>
                </div>
              );
          ...
          {selectedEmail ? (
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-5">
              ...
              <div className="flex justify-between items-start border-b border-slate-800 pb-4">
                <div>
                  <div className="text-[10px] text-amber-400 uppercase font-bold">From: {selectedEmail.senderEmail}</div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3 bg-slate-950 p-4 rounded-xl border border-slate-800 text-[11px]">
                  ...
                  <div>
                    <span className="text-slate-500 font-bold">PO Number:</span> <strong className="text-amber-400">{selectedEmail.poNumber}</strong>
                  </div>
                  <div>
                  ...
                  <tbody className="divide-y divide-slate-800">
                    {selectedEmail.items.map((it, idx) => (
                      <tr key={idx} className="bg-slate-950/60">
                        ...
                        <td className="p-2 text-amber-300 font-bold">{it.materialGrade}</td>
              ...
              <div className="flex justify-end gap-3 pt-2">
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs transition-all shadow active:scale-95"
                >
            ...
            <div className="p-12 text-center text-slate-600 bg-slate-900 border border-slate-800 rounded-2xl">
              <Mail className="h-10 w-10 mx-auto mb-2 opacity-40 text-amber-400" />
