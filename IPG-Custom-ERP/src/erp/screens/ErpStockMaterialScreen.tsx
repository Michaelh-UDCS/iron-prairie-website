                ...
                <tr key={stk.id} className="hover:bg-slate-800/40 transition-colors">
                  ...
                  <td className="p-3 text-center">
                    <button
                      ...
                      className="px-2.5 py-1 rounded-xl bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 border border-amber-500/40 font-bold text-[11px] transition-colors"
                    >
                      Allocate to Job #
                    </button>
                  </td>
          ...
          <div className="relative w-full max-w-md bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl overflow-hidden font-mono text-xs">
            ...
            <form onSubmit={handleConfirmAllocation} className="p-6 space-y-4">
              <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-800 space-y-1">
                <div className="font-bold text-amber-400">{allocatingItem.subType}</div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-amber-400 font-black focus:outline-none"
                    required
                  />
                </div>
              </div>
