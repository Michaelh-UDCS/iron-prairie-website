...
export const ErpDashboardScreen: React.FC = () => {
  ...
  return (
    <div className="space-y-6 font-mono">
      ...
      <div className="rounded-2xl border border-slate-800 bg-gradient-to-r from-slate-900 via-slate-900 to-amber-950/30 p-5 sm:p-6 shadow-xl">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <button
              ...
              className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 text-xs font-black transition-all shadow-md active:scale-95"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {lowStockCount > 0 && (
            <div
              ...
              className="p-3.5 rounded-xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-between text-xs cursor-pointer hover:bg-amber-500/20 transition-all"
            >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
        ...
        <div
          ...
          className="p-4 rounded-2xl bg-slate-900 border border-slate-800 hover:border-amber-500/50 cursor-pointer transition-all group"
        >
        ...
        <div
          ...
          className="p-4 rounded-2xl bg-slate-900 border border-slate-800 hover:border-sky-500/50 cursor-pointer transition-all group"
        >
          <div className="flex items-center justify-between text-slate-400 mb-2">
            <span className="text-[10px] uppercase font-bold tracking-wider">MTR Heat #s</span>
            <ShieldCheck className="h-4 w-4 text-sky-400 group-hover:scale-110 transition-transform" />
          </div>
          <div className="text-2xl font-black text-sky-400">{mtrDatabase.length}</div>
        ...
        >
          <div className="flex items-center justify-between text-slate-400 mb-2">
            ...
            <Boxes className="h-4 w-4 text-amber-400 group-hover:scale-110 transition-transform" />
          </div>
          <div className="text-2xl font-black text-amber-400">{stockInventory.length} SKUs</div>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900 p-4 space-y-3">
            <p className="text-[11px] text-slate-400 leading-relaxed">
              When orders or RFQs are received from <span className="text-amber-400 font-semibold">sales@iron-prairie.com</span>, they are parsed and populate the dashboard automatically with assigned Job #s.
            </p>
            ...
            <div className="space-y-2.5 max-h-[380px] overflow-y-auto">
              {salesEmailTriggers.map((trig) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-amber-400 truncate">{trig.companyName}</span>
                  ...
                  <div className="flex items-center justify-between text-[10px] text-slate-400 pt-1 border-t border-slate-900">
                    ...
                    {trig.generatedJobNumber ? (
                      ...
                      <span className="text-amber-400 font-bold">Pending Conversion</span>
                    )}
                  </div>
                </div>
              ))}
