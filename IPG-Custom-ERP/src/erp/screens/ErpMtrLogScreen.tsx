          ...
          {selectedMtr ? (
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-5">
              ...
              <div className="flex justify-between items-start border-b border-slate-800 pb-4">
                <div>
                  <div className="text-[10px] text-amber-400 font-bold uppercase">Certified Mill Test Report</div>
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs transition-all shadow"
                  >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 bg-slate-950 p-4 rounded-xl border border-slate-800 text-[11px]">
                ...
                <div>
                  ...
                  <div className="font-mono text-amber-400">{selectedMtr.certificateNumber}</div>
                </div>
                <div>
              ...
              <div>
                ...
                <div className="grid grid-cols-4 sm:grid-cols-7 gap-2 text-center text-[10px]">
                  ...
                  <div className="p-2 rounded bg-slate-950 border border-slate-800">
                    ...
                    <strong className="text-amber-400 font-mono">{selectedMtr.chemistry.carbonEquivalent || 0.42}</strong>
                  </div>
                  <div className="p-2 rounded bg-slate-950 border border-slate-800">
              ...
              <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 space-y-2">
                <div className="font-bold text-amber-400 uppercase text-[10px]">Cross-Referenced Work Orders</div>
                  ...
                  {workOrders.filter(w => w.allocatedHeatNumbers.includes(selectedMtr.heatNumber)).length === 0 ? (
                    ...
                    workOrders.filter(w => w.allocatedHeatNumbers.includes(selectedMtr.heatNumber)).map(wo => (
                      <button
                        ...
                        className="px-2 py-1 rounded bg-slate-900 border border-amber-500/30 text-amber-300 font-bold hover:bg-slate-800 transition-colors"
                      >
            ...
            <div className="p-12 text-center text-slate-600 bg-slate-900 border border-slate-800 rounded-2xl">
              <ShieldCheck className="h-10 w-10 mx-auto mb-2 opacity-40 text-amber-400" />
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-amber-400 font-black text-xs focus:outline-none"
                    required
                  />
                </div>
                <div>
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-slate-950 print:hidden">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3.5 py-1.5 rounded-xl bg-amber-500 text-slate-950 font-black text-xs"
                >
                  Print Certificate
                </button>
            ...
            <div className="p-8 space-y-5 text-slate-100 print:text-black print:p-6 font-mono text-xs">
              <div className="flex justify-between items-start border-b-2 border-slate-700 print:border-black pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-black text-amber-400 print:text-black text-sm uppercase">IRON PRAIRIE GROUP LLC</div>
