      ...
      <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-[11px]">
          <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 space-y-1">
            <div className="font-bold text-amber-400">📁 01_Work_Orders/</div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-3">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs transition-all shadow active:scale-95"
            >
              <Sparkles className="h-4 w-4" />
